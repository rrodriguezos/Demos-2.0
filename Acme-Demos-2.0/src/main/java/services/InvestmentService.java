...
public class InvestmentService {
	...
	public Collection<Investment> findInvestmentByInvestor(int investorId) {
		Collection<Investment> res = investmentRepository
				.findInvestmentByInvestor(investorId);
		Assert.notNull(res);
		return res;
	}
	...
	public Collection<Investment> investmentsByInvestorLogged() {
		...
		result = investmentRepository.investmentsByInvestorLogged(investor
				.getId());
	...
	public Collection<Investment> findInvestmentsByBank(int bankId) {
		Collection<Investment> result;
		result = investmentRepository.findInvestmentByBank(bankId);
